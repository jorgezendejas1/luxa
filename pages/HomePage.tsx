    ...
    return (
        <div className="animate-fade-in">
            ...
            <div className="relative bg-gray-200 h-64 md:h-96 flex items-center justify-center text-center overflow-hidden">
                <img src="https://images.unsplash.com/photo-1445205170230-053b83016050?q=80&w=2071&auto=format&fit=crop&ixlib-rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Fashion Banner" className="absolute w-full h-full object-cover" loading="lazy"/>
            ...
            <section className="container mx-auto px-4 my-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                <div onClick={() => onSelectCategory('Bolsas')} className="relative h-80 rounded-lg overflow-hidden group cursor-pointer">
                    <img src="https://images.unsplash.com/photo-1553062407-98eeb6e0e843?q=80&w=1887&auto=format&fit=crop&ixlib-rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="Bolsas" loading="lazy"/>
                 ...
                 <div onClick={() => onSelectCategory('Accesorios')} className="relative h-80 rounded-lg overflow-hidden group cursor-pointer">
                    <img src="https://images.unsplash.com/photo-1620912189879-c73e1b01a1e0?q=80&w=1887&auto=format&fit=crop&ixlib-rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" alt="Accesorios" loading="lazy"/>
                    <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
